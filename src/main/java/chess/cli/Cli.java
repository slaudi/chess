    ...
    public static void main(String[] args) {
        ...
        while(!currentGame.currentPlayer.getLoser() && !currentGame.isADraw()) {                //keeps game running
            ...
            while (!generateAnswer(userInput, currentGame)) {                                   //evaluates Input
                ...
                assert selectedPiece != null;                                                   //Console-Output if selected Piece has wrong Colour
            ...
            Square startSquare = currentGame.board.getStartSquareFromInput(userInput);          //finally sets moving Piece from input
            Square finalSquare = currentGame.board.getFinalSquareFromInput(userInput);          //finally sets Square to move to from input
