...
public class SetImages {
    //TODO: background über gridpane / -fx-background schwarz/weiß setzen, keine images dazu benutzen?
    static Image BlackPawnOnWhite = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("BlackPawnOnWhite.png")));
    static Image BlackPawnOnBlack = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("BlackPawnOnBlack.png")));
    static Image WhitePawnOnWhite = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("WhitePawnOnWhite.png")));
    static Image WhitePawnOnBlack = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("WhitePawnOnBlack.png")));
    static Image BlackRookOnWhite = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("BlackRookOnWhite.png")));
    static Image BlackRookOnBlack = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("BlackRookOnBlack.png")));
    static Image WhiteRookOnWhite = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("WhiteRookOnWhite.png")));
    static Image WhiteRookOnBlack = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("WhiteRookOnBlack.png")));
    static Image BlackKnightOnWhite = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("BlackKnightOnWhite.png")));
    static Image BlackKnightOnBlack = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("BlackKnightOnBlack.png")));
    static Image WhiteKnightOnWhite = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("WhiteKnightOnWhite.png")));
    static Image WhiteKnightOnBlack = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("WhiteKnightOnBlack.png")));
    static Image BlackBishopOnWhite = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("BlackBishopOnWhite.png")));
    static Image BlackBishopOnBlack = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("BlackBishopOnBlack.png")));
    static Image WhiteBishopOnWhite = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("WhiteBishopOnWhite.png")));
    static Image WhiteBishopOnBlack = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("WhiteBishopOnBlack.png")));
    static Image BlackQueenOnWhite = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("BlackQueenOnWhite.png")));
    static Image BlackQueenOnBlack = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("BlackQueenOnBlack.png")));
    static Image WhiteQueenOnWhite = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("WhiteQueenOnWhite.png")));
    static Image WhiteQueenOnBlack = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("WhiteQueenOnBlack.png")));
    static Image BlackKingOnWhite = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("BlackKingOnWhite.png")));
    static Image BlackKingOnBlack = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("BlackKingOnBlack.png")));
    static Image WhiteKingOnWhite = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("WhiteKingOnWhite.png")));
    static Image WhiteKingOnBlack = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("WhiteKingOnBlack.png")));
    static Image EmptyWhite = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("emptyWhite.png")));
    static Image EmptyBlack = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("emptyBlack.png")));
    //Highlighted
    static Image BlackPawnOnWhiteX = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("BlackPawnOnWhiteX.png")));
    static Image BlackPawnOnBlackX = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("BlackPawnOnBlackX.png")));
    static Image WhitePawnOnWhiteX = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("WhitePawnOnWhiteX.png")));
    static Image WhitePawnOnBlackX = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("WhitePawnOnBlackX.png")));
    static Image BlackRookOnWhiteX = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("BlackRookOnWhiteX.png")));
    static Image BlackRookOnBlackX = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("BlackRookOnBlackX.png")));
    static Image WhiteRookOnWhiteX = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("WhiteRookOnWhiteX.png")));
    static Image WhiteRookOnBlackX = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("WhiteRookOnBlackX.png")));
    static Image BlackKnightOnWhiteX = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("BlackKnightOnWhiteX.png")));
    static Image BlackKnightOnBlackX = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("BlackKnightOnBlackX.png")));
    static Image WhiteKnightOnWhiteX = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("WhiteKnightOnWhiteX.png")));
    static Image WhiteKnightOnBlackX = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("WhiteKnightOnBlackX.png")));
    static Image BlackBishopOnWhiteX = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("BlackBishopOnWhiteX.png")));
    static Image BlackBishopOnBlackX = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("BlackBishopOnBlackX.png")));
    static Image WhiteBishopOnWhiteX = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("WhiteBishopOnWhiteX.png")));
    static Image WhiteBishopOnBlackX = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("WhiteBishopOnBlackX.png")));
    static Image BlackQueenOnWhiteX = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("BlackQueenOnWhiteX.png")));
    static Image BlackQueenOnBlackX = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("BlackQueenOnBlackX.png")));
    static Image WhiteQueenOnWhiteX = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("WhiteQueenOnWhiteX.png")));
    static Image WhiteQueenOnBlackX = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("WhiteQueenOnBlackX.png")));
    static Image BlackKingOnWhiteX = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("BlackKingOnWhiteX.png")));
    static Image BlackKingOnBlackX = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("BlackKingOnBlackX.png")));
    static Image WhiteKingOnWhiteX = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("WhiteKingOnWhiteX.png")));
    static Image WhiteKingOnBlackX = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("WhiteKingOnBlackX.png")));
    static Image EmptyWhiteX = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("emptyWhiteX.png")));
    static Image EmptyBlackX = new Image(Objects.requireNonNull(ChessBoardView.class.getResourceAsStream("emptyBlackX.png")));


    public static ImageView chooseImage(Type type, Colour colour) {
    ...
    public static ImageView chooseImage(Square square) {
    ...
    public static ImageView chooseHighlightedImage(Square square) {
